...
function ProgramScreen({ program, weekNumber, matchInput, onToday, onLogout }) {
  ...
  return <div style={s.page}>
    ...
    <Card><Label tone="muted">Sådan udvikler planen sig</Label><p style={{ ...s.body, color: color.text, margin: 0 }}>Et fuldt gennemført hovedløft inden for rep- og RPE-målet giver normalt 2,5 kg mere næste uge. “For hård”, manglende reps eller høj RPE holder vægten. Assistance starter med din senest loggede belastning.</p></Card>
