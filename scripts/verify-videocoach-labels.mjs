...
assert.equal(videoCoachVariationLabel('bench', 'Slingshot bænk'), 'Slingshot bænk')
assert.equal(videoCoachVariationLabel('bench', 'slingshot_baenk'), 'Slingshot bænk')
assert.equal(videoCoachVariationLabel('bench', 'slingshot_b_nk'), 'Slingshot bænk')
...
assert.equal(videoCoachVariationIdentity('bench', 'Slingshot bænk'), 'slingshot_b_nk')
assert.equal(videoCoachVariationIdentity('bench', 'slingshot_baenk'), 'slingshot_b_nk')
assert.equal(videoCoachVariationIdentity('bench', 'slingshot_b_nk'), 'slingshot_b_nk')
