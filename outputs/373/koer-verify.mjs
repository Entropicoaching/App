// ORDRE 373 — sikkerhedslinen: `npm run build` + `npm run lint` + alle
// verify:*-scripts fra package.json (ingen af dem kræver net eller
// hemmeligheder, se docs/ATHLETEVIEW-KORT.md), bestået/fejlet pr. script,
// plus bundtstørrelser fra dist/assets. Skrives til outputs/373/<fase>.json.
// Kørsel: node outputs/373/koer-verify.mjs foer|efter
...
writeFileSync(join(ROOT, 'outputs', '373', `${FASE}.json`), JSON.stringify(result, null, 2) + '\n')
