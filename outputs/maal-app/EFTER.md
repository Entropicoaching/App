...
Målt 2026-09-12 13:12 UTC, 3 profiler × 6 skærme, med attrap-data (ingen atletdata).

**Den autentificerede skal** (main + AthleteView-chunk — det SPA'en henter uanset hvilken atlet-fane der vises, "dagens pas"/"sæt-logger"/"opvarmning"/"check-in" deler denne): 658 KB (index-CYhpEthV.js, AthleteView-9dvUZ7Z_.js, index-nqMpL4T3.css). Login og videocoach-forsiden er selvstændige og har deres egen sidevægt i tabellen nedenfor.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| iPhone 13 | Login | 65 | 87 | 415 | 1 | 0 | nej | 0 |
...
| iPhone 13 | Videocoach-forside (uden video) | 71 | 93 | 541 | 0 | 0 | nej | 0 |
| iPhone 13 | Check-in (parathed) | 99 | 87 | 14 | 1 | 0 | nej | 0 |
| Android 360×740 | Login | 74 | 87 | 415 | 1 | 0 | nej | 0 |
...
| Android 360×740 | Videocoach-forside (uden video) | 71 | 93 | 541 | 0 | 0 | nej | 0 |
| Android 360×740 | Check-in (parathed) | 100 | 87 | 14 | 1 | 0 | nej | 0 |
| Desktop 1280×800 | Login | — | — | 415 | 1 | 0 | nej | 0 |
...
| Desktop 1280×800 | Videocoach-forside (uden video) | — | — | 551 | 0 | 3 | nej | 0 |
| Desktop 1280×800 | Check-in (parathed) | — | — | 14 | 1 | 0 | nej | 0 |
...
- **iPhone 13::Login**: perf 66 → 65, a11y 75 → 87, sidevægt 415 KB, axe-fejl 2 → 1, trykflader<44px 3 → 0
...
- **iPhone 13::Videocoach-forside (uden video)**: perf 71, a11y 93, sidevægt 537 → 541 KB, axe-fejl 0, trykflader<44px 0
- **iPhone 13::Check-in (parathed)**: perf 100 → 99, a11y 87, sidevægt 13 → 14 KB, axe-fejl 1, trykflader<44px 5 → 0
- **Android 360×740::Login**: perf 74, a11y 75 → 87, sidevægt 415 KB, axe-fejl 2 → 1, trykflader<44px 3 → 0
...
- **Android 360×740::Videocoach-forside (uden video)**: perf 78 → 71, a11y 93, sidevægt 537 → 541 KB, axe-fejl 0, trykflader<44px 0
- **Android 360×740::Check-in (parathed)**: perf 100, a11y 87, sidevægt 13 → 14 KB, axe-fejl 1, trykflader<44px 5 → 0
- **Desktop 1280×800::Login**: perf undefined, a11y undefined, sidevægt 415 KB, axe-fejl 2 → 1, trykflader<44px 0
...
- **Desktop 1280×800::Videocoach-forside (uden video)**: perf undefined, a11y undefined, sidevægt 547 → 551 KB, axe-fejl 0, trykflader<44px 3
- **Desktop 1280×800::Check-in (parathed)**: perf undefined, a11y undefined, sidevægt 13 → 14 KB, axe-fejl 1, trykflader<44px 5 → 0
