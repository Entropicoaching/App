// ORDRE 387 (kopi af outputs/373/skaermbilleder.mjs, mappe foer-atlet/efter-atlet) — headless skærmbilleder af atletens hovedskærme på 390 px mod
...
//   node outputs/387/skaermbilleder-atlet.mjs foer|efter
...
const OUT = join(new URL('.', import.meta.url).pathname.replace(/^\/([A-Za-z]:)/, '$1'), FASE + '-atlet')
